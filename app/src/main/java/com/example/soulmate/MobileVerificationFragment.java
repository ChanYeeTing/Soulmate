 ...
 * Use the {@link MobileVerificationFragment#newInstance} factory method to
...
public class MobileVerificationFragment extends Fragment {
    ...
    public void onActivityCreated ( @Nullable Bundle savedInstanceState ) {
        ...
        Button submit2;
        submit2 = getView ().findViewById ( R.id.submitButton2 );
        submit2.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick ( View v ) {
                NavController controller = Navigation.findNavController (v);
                controller.navigate ( R.id.action_mobileVerificationFragment_to_login_fragment );
            }
        } );
    }
}